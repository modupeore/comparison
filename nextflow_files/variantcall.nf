...
PICARDDIR = "/home/modupeore17/.software/picard-tools-1.136/picard.jar"
GATKDIR = "/home/modupeore17/.software/GenomeAnalysisTK-3.3-0/GenomeAnalysisTK.jar"
REF = "/home/modupeore17/.GENOMES/chicken/chicken.fa"
  

params.ffiles = "/storage2/modupeore17/COMPARISON/bamfiles/SORTED/*sorted*"
...
process addreplace {
  ...
  shell:
    """
    nice -n 12 java -jar $PICARDDIR AddOrReplaceReadGroups \
    	INPUT=${bam} \
...
process markduplicate {
  ...
  shell:
    """
    nice -n 12 java -jar $PICARDDIR MarkDuplicates \
  		INPUT=${bam} \
...
process splitNcigar {
  ...
  shell:
    ...
    nice -n 12 java -jar $GATKDIR -T SplitNCigarReads \
  		-R $REF \
  		-I ${bam} \
...
process HaplotypeCaller {
  ...
  shell:
    """
    nice -n 12 java -jar $GATKDIR -T HaplotypeCaller \
  		-R $REF \
  		-I ${bam} \
  		-o ${prefix}.vcf
